...
# rpmbuild -ta glusterfs-3.4.1.tar.gz --without rdma
...
# rpmbuild -ta glusterfs-3.4.1.tar.gz --without epoll
%{?_without_epoll:%global _without_epoll --disable-epoll}

# if you wish to compile an rpm without fusermount...
# rpmbuild -ta glusterfs-3.4.1.tar.gz --without fusermount
%{?_without_fusermount:%global _without_fusermount --disable-fusermount}

# if you wish to compile an rpm without geo-replication support, compile like this...
# rpmbuild -ta glusterfs-3.4.1.tar.gz --without georeplication
%{?_without_georeplication:%global _without_georeplication --disable-geo-replication}

# if you wish to compile an rpm without the OCF resource agents...
# rpmbuild -ta glusterfs-3.4.1.tar.gz --without ocf
...
%else
Source0:          glusterfs-3.4.1.tar.gz
%endif
